...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../css/handmadedescription.css">
        <link rel="stylesheet" href="../css/handmadedesresponsive.css">
...
$(".toggle").click(function () {
    ...
    <div class="item">
        <div class="imge">
            <img src="{{url('storage/products/'.$product->image)}}" id="handmade" >
        ...
        <div class="words">
            ...
            <button id="myBtn" style="visibility:{{auth()->id() === $product->user_id?"":"hidden" }} " >Edit</button>
            <!-- The Modal -->
            <div id="myModal" class="modal"  >
                <!-- Modal content -->
                <div class="content">
                    <span class="close" style=" font-size: 35px;color: #ff0000;">&times;</span>
                    <form class="edit-item" method="post" action="{{url('products/'.$product->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <!-- select photo -->
                        <center  class="photo">
                            <img id="blah" src="{{url('/storage/products/'.$product->image)}}" alt="your image" />
    ...
    <div class="price">
        <h2>Price</h2>
        <p>{{$product->price>0?$product->price.' LE':"Free"}}</p>
    </div>
    ...
    <div class="contacts">
        <h3>contacts</h3>
        <p><i class="fa fa-phone" id="phone"></i>{{$product->phone}}</p>
        <p><i class="fa fa-facebook-square" id="facebook" aria-hidden="true"></i>{{$product->facebook}}</p>
    </div>
    ...
    <div id="myModalete" class="modal">
        ...
        <div class="contentreport">
            ...
            <form class="edit-item" method="post" action="{{url('products/'.$product->id.'/report')}}">
                @csrf
