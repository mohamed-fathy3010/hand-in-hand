                     ...
                     <div class="landing">
                       <div class="landing-image">
                          ...
                          <div class="hand">
                           ...
                           you can Share , exchange , and sell educational materials like books or tools ,Offer services like teaching subjects or answering
                           college subjects question ,Announce and group events and Sell hand-made products.</h2>
                           <br>
                           @guest
                           <a href="{{route('register')}}" data-value="foll"class="register"> Register</a>
                           @endguest
                           @auth
           ...
           <div class="cotainer">
            <div class="row" >
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
               <div class="items">
                  <div class="image">
                    <img src="{{asset('images/marginalia-education.png')}}"class="ig1"style="width: 40%;height: 90%;transform: rotatey(180deg);position: absolute;margin: 0px 0 0 0;" >
                    <h3>ITEMS</h3>
                  </div>
                    <img src="{{asset('images/path2.png')}}"class="background1" style="width: 600px; height: 250px;position: relative">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="items">
                    <div class="image">
                    <img src="{{asset('images/undraw_collab_8oes.png')}}"style="width: 40%;height: 80%;position: absolute;margin: 10px 0 0 0;" >
                    <h3>SERVICES</h3>
                  </div>
         ...
         <div class="cotainer" style="margin-top: 300px">
            <div class="row" >
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
               <div class="items">
                  <div class="image">
                    <img src="{{asset('images/marginalia-education.png')}}"style="width: 40%;height: 90%;transform: rotatey(180deg);position: absolute;margin: 0px 0 0 0;" >
                    <h3>EVENTS</h3>
                  </div>
                     <img src="{{asset('images/path2.png')}}" style="width: 600px; height: 250px;position: relative">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="items">
                    <div class="image">
                    <img src="{{asset('images/undraw_good_team_m7uu.png')}}"style="width: 40%;height: 90%;position: absolute;margin: 0px 0 0 0;" >
                    <h3>HANDMADE</h3>
                  </div>
                   <img src="{{asset('images/path2.png')}}" style="width: 600px; height: 250px;position: relative">
                       <div class="paragrph">
